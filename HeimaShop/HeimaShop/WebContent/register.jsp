...
<script type="text/javascript">
	...
	$(function(){
		$("#checkImg").click(function(){
			$(this).attr("src","${pageContext.request.contextPath}/checkImg?date="+new Date().getTime());
		});
	})
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" id="myform" style="margin-top: 5px;" method="post" 
				action="${pageContext.request.contextPath }/user?method=check">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							...
							<label class="radio-inline">
							<input type="radio" name="sex" id="fmale" value="fmale">女
							</label>
