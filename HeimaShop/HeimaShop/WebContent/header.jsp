...
<div class="container-fluid">
	<div class="col-md-4">
		<a href="${pageContext.request.contextPath}/start.jsp"><img src="img/logo2.png" /></a>
	</div>
	<div class="col-md-5">
	...
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			...
			<c:if test="${not empty user}">
				...
				<li><a href="${pageContext.request.contextPath}/user?method=logout" onclick="javascript:alert('注销成功')">注销</a></li>
			</c:if>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath}/start.jsp">首页</a>
			</div>
