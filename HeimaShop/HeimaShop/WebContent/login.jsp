...
<script type="text/javascript">
	...
	$(function(){
		$("#checkNum").click(function(){
			$(this).attr("src","${pageContext.request.contextPath}/checkNum?date="+new Date().getTime());
		});
	})	
</script>
</head>
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div>&nbsp;</div>
					<form class="form-horizontal" action="${pageContext.request.contextPath}/user?method=loginCheck" method="post">
						...
						<!-- 选中自动登陆 -->
						<c:if test="${not empty rememberUsername}">
							<script type="text/javascript">
								$(function(){
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="${pageContext.request.contextPath}/checkNum" id="checkNum"/>
							</div>
