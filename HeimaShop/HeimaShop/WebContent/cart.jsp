			...
			<div class="row">
				<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
					<img style="float: left;"
						购物车为空" src="${pageContext.request.contextPath}/images/cart-empty.png">
					<div style="float: left; margin: 80px;">
						<h2 style="color: grey;">您的购物车还是空的！</h2>
						<h3 style="color: grey;">登录后将显示您之前加入的商品</h3>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
							...
							<c:forEach items="${cart.cartItems}" var="entry">
								<tr class="active">
									...
									<td><a href="javascript:;" class="delete"
										onclick="delProFromCart('${entry.value.product.pid}')">删除</a></td>
								</tr>
							</c:forEach>
			...
			<div style="margin-right: 130px;">
				<div style="text-align: right;">
					 赠送积分: <em style="color: #ff6600;">${cart.total/10}</em>
					 		&nbsp; 商品金额: 
